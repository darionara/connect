...
export class NightlySelector extends LitElement {
  ...
  render() {
    return html`
      <div
        class="nc_modalOverlay  ${this.fireClosingAnimation ? 'nc_overlayClosingAnimation' : ''}"
      ...
      >
        <div
          ...
          class="nc_modalWrapper ${this.fireClosingAnimation
            ...
            : ''}  ${this.fireClosingAnimation ? 'nc_modalClosingAnimation' : ''}"
        >
          ...
          <nightly-footer class="nc_modalFooter"></nightly-footer>
        </div>
      </div>
    `
  }
